...
class UpdateFeelingRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'emoji' => ['sometimes', 'required', 'string', 'max:32'],
    ...
    public function messages(): array
    {
        return [
            ...
            'is_active.required' => 'is_active e obrigatorio quando informado.',
